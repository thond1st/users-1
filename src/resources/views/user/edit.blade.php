        ...
        <div class="row">
            ...
            <div class="col-md-2">
                <div class="form-group">
                    ...
                    <input type="text" name="phone_prefix" value="{{ $user->phone_prefix }}" class="form-control" maxlength="2">
                </div>
            </div>
            ...
            <div class="col-md-4">
                <div class="form-group">
                    ...
                    <input type="text" name="phone_number" value="{{ $user->phone_number }}" class="form-control" maxlength="15">
                </div>
            </div>
